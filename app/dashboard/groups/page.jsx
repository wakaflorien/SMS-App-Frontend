...
import { TABLE_HEAD_GROUP, TABLE_ROWS_CONTACTS } from "@/app/components/tablecolumns";
            ...
            <div className="flex flex-col  p-4 space-y-3">
                ...
                <Card className="h-fit w-full rounded-none space-y-4">
                    <div className="w-3/6 px-6 pt-6">
                        <Input label="Search group by name, number" size="md" icon={<UserGroupIcon className="h-5 w-5" />} />
                    </div>
