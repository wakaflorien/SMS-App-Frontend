...
export default function DashbaordLayout({ children }) {
    ...
    return (
        <div className="flex">
            <Card className="h-inherit w-full max-w-[20rem] p-4 border-r shadow-xl shadow-blue-gray-900/5 rounded-none">
                        ...
                        {sideNav.map((item, index) =>
                            ...
                            >
                                ...
                                <AccordionBody className="py-1">
                                    <List className="p-0">
                                        {messageMenu?.map((subItem, subIndex) => <ListItem key={subIndex} onClick={() => handleRoute(subItem.link)}>
                                            <ListItemPrefix>
